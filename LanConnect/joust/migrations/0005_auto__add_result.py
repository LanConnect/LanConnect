...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Result'
        db.create_table('joust_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['joust.Entrant'])),
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['joust.Match'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('joust', ['Result'])


    def backwards(self, orm):
        
        # Deleting model 'Result'
        db.delete_table('joust_result')

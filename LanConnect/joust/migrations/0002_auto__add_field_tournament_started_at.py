...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tournament.started_at'
        db.add_column('joust_tournament', 'started_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tournament.started_at'
        db.delete_column('joust_tournament', 'started_at')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # renaming field 'Match.tournament_game'
        db.rename_column('joust_match', 'tournament_game_id', 'tournament_id')

    def backwards(self, orm):
        # renaming field 'Match.tournament'
        db.rename_column('joust_match', 'tournament_id', 'tournament_game_id')

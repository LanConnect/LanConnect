...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.special'
        db.add_column('joust_result', 'special', self.gf('django.db.models.fields.CharField')(max_length=1, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.special'
        db.delete_column('joust_result', 'special')
    ...
    models = {
        ...
        'joust.match': {
            ...
            'station': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_matches_played'", 'null': 'True', 'to': "orm['joust.Station']"}),
        ...
        'joust.result': {
            ...
            'entrant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['joust.Entrant']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['joust.Match']"}),
            'score': ('django.db.models.fields.IntegerField', [], {}),
            'special': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True'})
        },
        'joust.station': {
